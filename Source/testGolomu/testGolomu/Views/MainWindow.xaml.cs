...
namespace testGolomu.Views
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ChatNeWork(string chat)
        {
            ...
            if (chat.Contains("from"))
            {
                if (chat.Contains("\"from\": \"" + Player1 + "\""))
                    ...
                    index = 1;
                chat = chat.Substring(32);
                int n = chat.IndexOf("\"");
                //MessageBox.Show("\"");
                chat = chat.Substring(0, n);
        ...
        private void ViewModels_ClickChat(string Show)
        {
            if (Show != null)
            {
              ...
              //  BChat.AppendText(Show + "\n");
                ...
                if(Index == 3 || Index == 4)
                    socket.Emit("ChatMessage", JObject.FromObject(new { Show }));
        ...
        public void ComputerChat(int x, int y)
        {
            ...
            lb.Background = Brushes.Red;
            lb2.Background = Brushes.Red;
            lb.Content = "Computers just go (" + x.ToString() + ";" + y.ToString() ;
            STChat.Children.Add(lb);
            lb2.Content = DateTime.Now;
            STChat.Children.Add(lb2);
        }
     ...
     public void SystemChat(int x, int y, int z, String _Name)
      ...
      public  void InitiIsBlack()
        ...
        public void CheckWin( int NumRow, int _Player,int[] IsBlack)
        {
                    ...
                    if (IsBlack[i * 12 + j] > 2 && IsBlack[i * 12 + j] % 10 == _Player)
                    {
                        ...
                        if (j < NumRow - 4)
                            if ((IsBlack[PointChess + 1] % 10 == Value % 10) && (IsBlack[PointChess + 2] % 10 == Value % 10) && (IsBlack[PointChess + 3] % 10 == Value % 10) && (IsBlack[PointChess + 4] % 10 == Value % 10))
                                isWin = true;
                        if (i < 8)
                            if ((IsBlack[PointChess + NumRow] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 2] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 3] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 4] % 10 == Value % 10))
                                isWin = true;
                        if (i < 8 && j < 8)
                            if ((IsBlack[PointChess + NumRow + 1] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 2 + 2] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 3 + 3] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 4 + 4] % 10 == Value % 10))
                                isWin = true;
                        if (i < 8 && j > 3)
                            if ((IsBlack[PointChess + NumRow - 1] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 2 - 2] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 3 - 3] % 10 == Value % 10) && (IsBlack[PointChess + NumRow * 4 - 4] % 10 == Value % 10))
                                isWin = true;
                                ...
                                if (VirtualChess[k * 12 + l] % 10 == z)
                                {
                                    ...
                                    if (l < 12 - 4 && l > 0)
                                        if ((VirtualChess[PointChess + 1] % 10 == Value % 10) && (VirtualChess[PointChess + 2] % 10 == Value % 10) && (VirtualChess[PointChess + 3] % 10 == Value % 10) && (VirtualChess[PointChess + 4] < 3) && (VirtualChess[PointChess - 1] < 3))
                                            PointTrue = Value;
                                    if (k < 8 && k > 0)
                                        if ((VirtualChess[PointChess + NumRow] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 2] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 3] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 4] < 3) &&  (VirtualChess[PointChess - NumRow ] < 3))
                                            PointTrue = Value;
                                    if (k < 8 && l < 8 && l > 0 && k > 0)
                                        if ((VirtualChess[PointChess + NumRow + 1] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 2 + 2] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 3 + 3] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 4 + 4] < 3) && (VirtualChess[PointChess - NumRow  - 1] < 3))
                                            PointTrue = Value;
                                    if (k < 8 && l > 3 && k > 0 && l < 11)
                                        if ((VirtualChess[PointChess + NumRow - 1] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 2 - 2] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 3 - 3] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 4 - 4] < 3) && (VirtualChess[PointChess - NumRow  +1] < 3))
                                            PointTrue = Value;
                                ...
                                if (VirtualChess[k * 12 + l] % 10 == z)
                                {
                                    ...
                                    if (l < 10 && l > 0)
                                        if ((VirtualChess[PointChess + 1] % 10 == Value % 10)  && (VirtualChess[PointChess + 2] < 3) && (VirtualChess[PointChess - 1] < 3))
                                            PointTrue = z;
                                    if (k < 10 && k > 0)
                                        if ((VirtualChess[PointChess + NumRow] % 10 == Value % 10)  && (VirtualChess[PointChess + NumRow * 2] < 3) && (VirtualChess[PointChess - NumRow] < 3))
                                            PointTrue = z;
                                    if (k < 10 && l < 10 && l > 0 && k > 0)
                                        if ((VirtualChess[PointChess + NumRow + 1] % 10 == Value % 10) && (VirtualChess[PointChess + NumRow * 2 + 2] < 3) && (VirtualChess[PointChess - NumRow - 1] < 3))
                                            PointTrue = z;
                                    if (k < 10 && l > 1 && k > 0 && l < 11)
                                        if ((VirtualChess[PointChess + NumRow - 1] % 10 == Value % 10)  && (VirtualChess[PointChess + NumRow * 2 - 2] < 3) && (VirtualChess[PointChess - NumRow + 1] < 3))
                                            PointTrue = z;
